...
public class ClienteController {
	...
	public ResponseEntity<?> filtrar(@RequestParam(required = false) String nome,
		...
		return ResponseEntity.ok(model); // TODO
	}

	@GetMapping("{id}")
	public ResponseEntity<?> consultar(@PathVariable(name = "id") String id) {
	...
	@PutMapping("{id}")
	public ResponseEntity<?> alterar(@PathVariable(name = "id") String id,
